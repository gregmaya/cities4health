...
- Present the intersection of the field
    - Brief summary on history ("how far has the research advanced")
    - The different tangents: **NCDs**, epidemiology, mental health
    - The current integration of public health into urban policy.
        - How one part of it now sits under the broader umbrella of sustainable development goals (SDGs) and the global health agenda. -> Adaptation policy
        - How Europe is making it implementable through Sectorial Adaptation Plans - SAPS (= opportunity)
            - Identify sector's vulnerabilities
            - Set measurable targets
            - Detail hard (infrastructure) and soft (institutional and behavioral) measures that can be implemented at a city level.
        
- ("barriers") Current challenges
    - Policy Implementation
        - Knowledge transfers (KT)
        - The methodological execution (what do we measure and how)
    - The Economic/Business benefits -> Budget shifts !?
        - Potenial ROI from individual plans. 
        - The opportunity cost calculation of business as usual.
    - Data resolution gap.
        -  Urban determinants of health and health reports/outcomes
        - Health Impact Assesments (HIA): an few tools but no concensus.
...
- ("openings") 
    ...
    - EU Policy market for development of SAPS
        - eg. Ireland: Health 2019-2024. 
        - Too high level and vague to put in practice.
...
Title:
State-of-the-Art in Health-Driven Urban Adaptation in Europe: Integrating System Science, Complex Adaptive Models, and Sectoral Adaptation Plans (SAPS)
